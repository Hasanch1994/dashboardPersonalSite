        ...
        >
          ...
          <div
            ...
            className={`absolute z-10 ${
              !showMore ? "invisible" : ""
            } right-full inline-block min-w-[9rem] text-sm font-light text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-sm opacity-1 `}
          >
            <div className="px-3 py-2 bg-gray-100 border-b border-gray-200 rounded-t-lg ">
              <h3 className="font-semibold text-gray-900 ">actions</h3>
            </div>
            <ul className="text-left">
              <li className="py-3 px-2 flex items-center justify-start gap-x-2 hover:bg-gray-100">
                <svg
                  fill="#000000"
                  className="w-4 h-4 text-gray-500 transition duration-75  group-hover:text-gray-900 "
                  viewBox="0 0 24 24"
